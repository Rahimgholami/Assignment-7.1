...
CPP11 = g++ -std=c++11
OBJ = main.o FileSystemInterface.o CommandHandler.o User.o Film.o Publisher.o
...
Film.o:	Film.cpp Film.h Define.h Exception.h
	$(CPP11) Film.cpp -c

User.o:	User.cpp User.h Define.h Exception.h
		$(CPP11) User.cpp -c
